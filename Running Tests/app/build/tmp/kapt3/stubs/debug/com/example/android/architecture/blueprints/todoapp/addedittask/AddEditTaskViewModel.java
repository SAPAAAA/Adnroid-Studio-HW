...
public final class AddEditTaskViewModel extends androidx.lifecycle.AndroidViewModel {
    ...
    private final androidx.lifecycle.MutableLiveData<com.example.android.architecture.blueprints.todoapp.Event<kotlin.Unit>> _taskUpdatedEvent = null;
    @org.jetbrains.annotations.NotNull()
    private final androidx.lifecycle.LiveData<com.example.android.architecture.blueprints.todoapp.Event<kotlin.Unit>> taskUpdatedEvent = null;
    ...
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<com.example.android.architecture.blueprints.todoapp.Event<kotlin.Unit>> getTaskUpdatedEvent() {
        return null;
    }
    ...
    private final void onTaskLoaded(com.example.android.architecture.blueprints.todoapp.data.Task task) {
    }
    ...
    private final kotlinx.coroutines.Job createTask(com.example.android.architecture.blueprints.todoapp.data.Task newTask) {
        return null;
    }
    
    private final void updateTask(com.example.android.architecture.blueprints.todoapp.data.Task task) {
    }
}