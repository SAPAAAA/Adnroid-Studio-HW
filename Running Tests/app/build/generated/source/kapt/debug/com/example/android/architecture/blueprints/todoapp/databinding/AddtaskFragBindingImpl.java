...
public class AddtaskFragBindingImpl extends AddtaskFragBinding implements com.example.android.architecture.blueprints.todoapp.generated.callback.OnClickListener.Listener {
    ...
    private AddtaskFragBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback4 = new com.example.android.architecture.blueprints.todoapp.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.example.android.architecture.blueprints.todoapp.addedittask.AddEditTaskViewModel) variable);
        }
        else {
            variableSet = false;
        }
