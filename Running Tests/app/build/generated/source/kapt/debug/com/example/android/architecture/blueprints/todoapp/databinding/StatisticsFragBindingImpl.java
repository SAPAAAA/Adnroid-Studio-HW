...
public class StatisticsFragBindingImpl extends StatisticsFragBinding  {
    ...
    private StatisticsFragBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 4
            , (com.example.android.architecture.blueprints.todoapp.ScrollChildSwipeRefreshLayout) bindings[0]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.example.android.architecture.blueprints.todoapp.statistics.StatisticsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.example.android.architecture.blueprints.todoapp.statistics.StatisticsViewModel Viewmodel) {
    ...
    protected void executeBindings() {
        ...
        com.example.android.architecture.blueprints.todoapp.statistics.StatisticsViewModel viewmodel = mViewmodel;
    ...
    public static class OnRefreshListenerImpl implements androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener{
        private com.example.android.architecture.blueprints.todoapp.statistics.StatisticsViewModel value;
        public OnRefreshListenerImpl setValue(com.example.android.architecture.blueprints.todoapp.statistics.StatisticsViewModel value) {
            this.value = value;
