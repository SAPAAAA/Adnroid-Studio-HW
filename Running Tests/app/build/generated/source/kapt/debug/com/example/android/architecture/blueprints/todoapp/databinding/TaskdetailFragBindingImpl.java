...
public class TaskdetailFragBindingImpl extends TaskdetailFragBinding implements com.example.android.architecture.blueprints.todoapp.generated.callback.OnClickListener.Listener {
    ...
    private TaskdetailFragBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 4
            ...
            , (com.example.android.architecture.blueprints.todoapp.ScrollChildSwipeRefreshLayout) bindings[1]
        ...
        setRootTag(root);
        // listeners
        mCallback3 = new com.example.android.architecture.blueprints.todoapp.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewmodelTask((androidx.lifecycle.LiveData<com.example.android.architecture.blueprints.todoapp.data.Task>) object, fieldId);
            case 2 :
    ...
    private boolean onChangeViewmodelTask(androidx.lifecycle.LiveData<com.example.android.architecture.blueprints.todoapp.data.Task> ViewmodelTask, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        com.example.android.architecture.blueprints.todoapp.data.Task viewmodelTaskGetValue = null;
        androidx.lifecycle.LiveData<com.example.android.architecture.blueprints.todoapp.data.Task> viewmodelTask = null;
        ...
        com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailViewModel viewmodel = mViewmodel;
    ...
    public static class OnRefreshListenerImpl implements androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener{
        private com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailViewModel value;
        public OnRefreshListenerImpl setValue(com.example.android.architecture.blueprints.todoapp.taskdetail.TaskDetailViewModel value) {
            this.value = value;
