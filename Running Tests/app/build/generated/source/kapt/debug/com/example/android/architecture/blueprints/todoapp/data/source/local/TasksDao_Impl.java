...
public final class TasksDao_Impl implements TasksDao {
  ...
  @Override
  public Object deleteTaskById(final String taskId,
  ...
  @Override
  public Object deleteTasks(final Continuation<? super Unit> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
  ...
  @Override
  public Object deleteCompletedTasks(final Continuation<? super Integer> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Integer>() {
      @Override
      public Integer call() throws Exception {
  ...
  @Override
  public Object getTasks(final Continuation<? super List<Task>> continuation) {
    final String _sql = "SELECT * FROM Tasks";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  @Override
  public Object getTaskById(final String taskId, final Continuation<? super Task> continuation) {
    final String _sql = "SELECT * FROM Tasks WHERE entryid = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (taskId == null) {
