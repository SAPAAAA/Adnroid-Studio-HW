...
public class TaskItemBindingImpl extends TaskItemBinding implements com.example.android.architecture.blueprints.todoapp.generated.callback.OnClickListener.Listener {
    ...
    private TaskItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback1 = new com.example.android.architecture.blueprints.todoapp.generated.callback.OnClickListener(this, 1);
        mCallback2 = new com.example.android.architecture.blueprints.todoapp.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.task == variableId) {
            setTask((com.example.android.architecture.blueprints.todoapp.data.Task) variable);
        }
    ...
    public void setTask(@Nullable com.example.android.architecture.blueprints.todoapp.data.Task Task) {
        this.mTask = Task;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.example.android.architecture.blueprints.todoapp.data.Task task = mTask;
        ...
        if ((dirtyFlags & 0x5L) != 0) {
            ...
            com.example.android.architecture.blueprints.todoapp.tasks.TasksListBindingsKt.setStyle(this.titleText, taskCompleted);
        }
    }
