...
public class TasksFragBindingImpl extends TasksFragBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((com.example.android.architecture.blueprints.todoapp.tasks.TasksViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable com.example.android.architecture.blueprints.todoapp.tasks.TasksViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewmodelItems((androidx.lifecycle.LiveData<java.util.List<com.example.android.architecture.blueprints.todoapp.data.Task>>) object, fieldId);
            case 2 :
    ...
    private boolean onChangeViewmodelItems(androidx.lifecycle.LiveData<java.util.List<com.example.android.architecture.blueprints.todoapp.data.Task>> ViewmodelItems, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        java.util.List<com.example.android.architecture.blueprints.todoapp.data.Task> viewmodelItemsGetValue = null;
        ...
        androidx.lifecycle.LiveData<java.util.List<com.example.android.architecture.blueprints.todoapp.data.Task>> viewmodelItems = null;
        ...
        com.example.android.architecture.blueprints.todoapp.tasks.TasksViewModel viewmodel = mViewmodel;
        ...
        if ((dirtyFlags & 0xc2L) != 0) {
            ...
            com.example.android.architecture.blueprints.todoapp.tasks.TasksListBindingsKt.setItems(this.tasksList, viewmodelItemsGetValue);
        }
    }
    ...
    public static class OnRefreshListenerImpl implements androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener{
        private com.example.android.architecture.blueprints.todoapp.tasks.TasksViewModel value;
        public OnRefreshListenerImpl setValue(com.example.android.architecture.blueprints.todoapp.tasks.TasksViewModel value) {
            this.value = value;
